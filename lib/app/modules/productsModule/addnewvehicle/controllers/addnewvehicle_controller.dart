...
class AddnewvehicleController extends GetxController {
  ...
  var selectedBodyType = "Station Wagon".obs;
  var selectedMake = "Toyota".obs;
  var selectedModel = "Probox".obs;
  ...
  Future<void> addNewProduct() async {
    try {
      ...
      data = newVehicle;
      bool isAdded =
          await productsRepository.uploadVehicle(newVehicle, selectedImages);
      ...
      if (isAdded) {
        Get.dialog(
          CustomSuccessDialog(
              title: "Vehicle Added!",
              message: "The Vehicle is Added Successfully!",
              onConfirm: () async {
                Get.back();
                Get.back();
                Get.back();
