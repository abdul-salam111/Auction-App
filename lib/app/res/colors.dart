...
class AppColors {
  // Primary Colors
  static const primaryColor = Color(0xFF00377B); // Example: Purple
  ...
  // Button Colors
  static const buttonColor = Color(0xFF1E88E5); // Example: Blue
  static const buttonDisabledColor = Colors.grey;

  static const borderColor = Color(0xFFECECEC); // Example: Light Grey
